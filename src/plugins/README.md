...
| `theme-editor` | страница расширения                     | Редактор своей палитры: переменные, свой CSS, пипетка                          |
...
| `course-view`  | `.../learn/courses/view/*`              | Список курсов и курс: карточки, дэшборд контрольных, автоскролл, экспорт и др. |
