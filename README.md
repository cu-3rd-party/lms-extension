...
Среди возможностей есть экспорт оценок: откройте LMS (`my.centraluniversity.ru` или `my.cu.ru`), в меню плагина (кнопка «Плагин» в шапке или значок расширения) раскройте «Экспорт оценок» и нажмите «Скачать Excel с оценками» — расширение скачает `grades.xlsx` с горизонтальными листами по курсам, названиями задач, пустыми слотами до планового количества заданий, цветовой разметкой и формулами прогноза накопленного балла по 10-балльной шкале. Архивные курсы выгружаются так же, отдельной кнопкой «Скачать Excel по архивным курсам», в `grades-archive.xlsx`.
...
Для установки расширения для браузера Safari откройте вкладку Releases справа, выберите самый свежий релиз и скачайте файл `lms-extension-safari.dmg`. После скачивания откройте DMG-образ и перетащите приложение в папку Applications. После первого запуска приложения расширение станет доступно в Safari в разделе «Расширения». После этого приложение можно закрыть и больше не открывать.

P. S. Если вы удалите приложение, расширение в Safari также будет удалено.

#### Решение проблем с установкой

Если у вас есть проблемы с установкой расширения попробуйте обновить Safari до последней версии, это можно сделать в системных настройках.
...
**Safari:** Откройте Настройки Safari → Дополнения → Включить «Показывать функции для веб-разработчика» → Разработчик → Включить «Разрешить неподписанные расширения» → «Добавить временное расширение» → выберите `dist/chrome/`.
